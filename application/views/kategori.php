                                        ...
                                        <form action="<?= site_url('kategori/simpan') ?>" method="post">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel1">Tambah Kategori
                                                        Produk</h5>
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            foreach ($kategori as $aa) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('kategori/hapus/' . $aa['id_kategori']); ?>"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="useredit<?= $aa['id_kategori'] ?>"
                                                            tabindex="-1" aria-hidden="true" style="display: none;">
                                                            <div class="modal-dialog" role="document">

                                                                <form action="<?= base_url('kategori/edit') ?>"
                                                                    method="post">
                                                                    <!-- lari ke Controller admin/kategori/update -->
                                                                    <input type="hidden" name="id_kategori"
                                                                        value="<?= $aa['id_kategori'] ?>">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="exampleModalLabel1">
                                                                                Perbarui Nama Kategori</h5>
