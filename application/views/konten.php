...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default"
    data-assets-path="<?= base_url('sneat') ?>/assets/" data-template="vertical-menu-template-free">
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="<?= base_url('sneat') ?>/assets/vendor/css/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="<?= base_url('sneat') ?>/assets/vendor/css/theme-default.css"
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bolder ms-2">TOKO ROTI</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-item">
                        <a href="<?= base_url('konten') ?>" class="menu-link ">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <input type="text" class="form-control border-0 shadow-none"
                                    aria-label="Search<?= base_url('sneat') ?>." />
                            </div>
                        </div>
                        <!-- /Search -->
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="<?= base_url('sneat') ?>/assets/img/avatars/1.png" alt
                            ...
                            <div class="col-lg-12 mb-4 order-0">
                                ...
                                <div class="modal fade" id="basicModal" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="<?= base_url('konten/simpan') ?>" method="post"
                                                    ...
                                                    <div class="row">
                                                        <div class="col mb-3">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="Nama Kategori Produk" name="judul" />
                                                        </div>
                                                    </div>
                                                    <div class="col mb-3">
                                        ...
                                        <tbody class="table-border-bottom-0">
                                            ...
                                            foreach ($konten as $aa) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?= base_url('upload/produk/' . $aa['foto']) ?>"
                                                            target="_blank">
                                                    ...
                                                    <td>
                                                        <a href="<?php echo site_url('konten/hapus/' . $aa['foto']); ?>"
                                                        ...
                                                        <!-- Modal -->
                                                        <div class="modal fade" id="Editkonten<?= $no; ?>" tabindex="-1"
                                                            aria-hidden="true" style="display: none;">
                                                            <div class="modal-dialog modal-lg" role="document">

                                                                <form action="<?= base_url('konten/update') ?>"
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            ...
                                                                            <div class="col mb-3">
                                                                                <label class="form-label">Foto (wajib
                                                                                    diisi)*</label>
